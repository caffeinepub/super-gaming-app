...
export class Backend implements backendInterface {
    ...
    async getAllScoresAscending(): Promise<Array<ScoreEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllScoresAscending();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllScoresDescending(): Promise<Array<ScoreEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllScoresDescending();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getScore(arg0: bigint): Promise<ScoreEntry> {
        if (this.processError) {
            try {
    ...
    async recordScore(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
